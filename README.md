# Snapshot: insulation-com-au

Static-site snapshot of **https://insulation.com.au/**
...
# 3. Verify
docker ps | grep insulation-com-au
```
...
```
insulation-com-au.yourdomain.com {
    reverse_proxy insulation-com-au:80
}
```
